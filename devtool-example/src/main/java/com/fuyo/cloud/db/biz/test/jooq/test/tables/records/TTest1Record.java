...
public class TTest1Record extends UpdatableRecordImpl<TTest1Record> implements Record4<Integer, String, LocalDateTime, Integer>, ITTest1 {

    private static final long serialVersionUID = -1073002762;
    ...
    @Override
    public TTest1Record value4(Integer value) {
        setType(value);
        return this;
    }

    @Override
    public TTest1Record values(Integer value1, String value2, LocalDateTime value3, Integer value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TTest1Record(Integer id, String name, LocalDateTime dateTime, Integer type) {
        super(TTest1.T_TEST1);
