...
public interface GTestDtoMapper {
     ...
     * @mbg.generated
     */
    Map selectOneToMap(@Param("example") GTestDtoExample example, @Param("expressions") String ... expressions);
     ...
     * @mbg.generated
     */
    List<Map> selectToMap(@Param("example") GTestDtoExample example, @Param("expressions") String ... expressions);
