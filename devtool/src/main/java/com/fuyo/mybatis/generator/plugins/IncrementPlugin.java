...
public class IncrementPlugin extends BasePlugin implements IIncrementPluginHook {
    ...
    private InnerEnum generateIncrementEnum(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        // 生成属性和构造函数
        Field columnField = new Field("column", new FullyQualifiedJavaType(com.fuyo.mybatis.generator.plugins.ModelColumnPlugin.ENUM_NAME));
        ...
        constructor.addParameter(new Parameter(new FullyQualifiedJavaType(com.fuyo.mybatis.generator.plugins.ModelColumnPlugin.ENUM_NAME), "column"));
        ...
        for (IntrospectedColumn introspectedColumn : this.incColumns) {
            ...
            sb.append("(");
            sb.append(com.fuyo.mybatis.generator.plugins.ModelColumnPlugin.ENUM_NAME);
            sb.append(".");
            sb.append(field.getName());
            sb.append(")");
