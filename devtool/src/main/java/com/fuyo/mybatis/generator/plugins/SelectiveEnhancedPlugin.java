...
import com.fuyo.mybatis.generator.plugins.utils.hook.IOptimisticLockerPluginHook;
import com.fuyo.mybatis.generator.plugins.utils.hook.IUpsertPluginHook;
...
public class SelectiveEnhancedPlugin extends BasePlugin implements IUpsertPluginHook, IOptimisticLockerPluginHook {
    ...
    public boolean validate(List<String> warnings) {
        ...
        if (!PluginTools.checkDependencyPlugin(getContext(), com.fuyo.mybatis.generator.plugins.ModelColumnPlugin.class)) {
            warnings.add("itfsw:插件" + this.getClass().getTypeName() + "插件需配合" + com.fuyo.mybatis.generator.plugins.ModelColumnPlugin.class.getTypeName() + "插件使用！");
            return false;
        }
    ...
    public boolean clientInsertSelectiveMethodGenerated(Method method, Interface interfaze, IntrospectedTable introspectedTable) {
        ...
        // column枚举
        FullyQualifiedJavaType selectiveType = new FullyQualifiedJavaType(fullFieldModel.getShortName() + "." + com.fuyo.mybatis.generator.plugins.ModelColumnPlugin.ENUM_NAME);
