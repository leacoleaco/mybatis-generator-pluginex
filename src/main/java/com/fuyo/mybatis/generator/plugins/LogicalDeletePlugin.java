...
import com.fuyo.mybatis.generator.plugins.utils.hook.ILogicalDeletePluginHook;
...
public class LogicalDeletePlugin extends BasePlugin {
    ...
    public void initialized(IntrospectedTable introspectedTable) {
        ...
        if (this.logicalDeleteColumn != null) {
            com.fuyo.mybatis.generator.plugins.EnumTypeStatusPlugin.EnumInfo enumInfo = null;
            try {
                enumInfo = new com.fuyo.mybatis.generator.plugins.EnumTypeStatusPlugin.EnumInfo(this.logicalDeleteColumn);
                // 解析注释
                enumInfo.parseRemarks(this.logicalDeleteColumn.getRemarks());
            } catch (com.fuyo.mybatis.generator.plugins.EnumTypeStatusPlugin.EnumInfo.NotSupportTypeException e) {
                this.logicalDeleteColumn = null;
            ...
            } catch (com.fuyo.mybatis.generator.plugins.EnumTypeStatusPlugin.EnumInfo.CannotParseException e) {
                // 这个异常不管，没有配置是正常的
            } finally {
