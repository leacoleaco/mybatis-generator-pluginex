...
public class UpsertPlugin extends BasePlugin {
    ...
    public boolean validate(List<String> warnings) {
        ...
        if (this.allowBatchUpsert && !PluginTools.checkDependencyPlugin(context, com.fuyo.mybatis.generator.plugins.ModelColumnPlugin.class)) {
            // 提示用户注意信息
            warnings.add("itfsw:插件" + this.getClass().getTypeName() + "插件您开启了allowBatchUpsert支持，请配置依赖的插件" + com.fuyo.mybatis.generator.plugins.ModelColumnPlugin.class.getTypeName() + "！");
        }
